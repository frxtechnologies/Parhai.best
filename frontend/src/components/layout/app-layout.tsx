    ...
    <div className="min-h-screen" style={{ background: "var(--background)" }}>
      ...
      <div className="md:pl-64 flex flex-col min-h-screen">
        ...
        <header className="h-16 px-4 md:px-8 bg-white/90 backdrop-blur-xl border-b border-slate-200/50 flex items-center justify-between sticky top-0 z-30 shadow-[0_1px_20px_rgba(11,31,58,0.06)]">
          {/* Search pill */}
          <label className="flex-1 max-w-lg flex items-center gap-3 bg-slate-50/90 rounded-xl px-4 py-2.5 border border-slate-200/70 cursor-text hover:border-slate-300 transition-colors focus-within:border-indigo-400 focus-within:ring-3 focus-within:ring-indigo-500/10 focus-within:bg-white">
